export const STORAGE_KEYS = {
    ...
    ONBOARDING_V3: 'suntrail_onboarding_v3',
    PLANNING_LONG_PRESS_HINT: 'suntrail_planning_long_press_hint_v1',
    PLANNING_CONTEXT_HINT_V2: 'suntrail_planning_context_hint_v2',
    RECORDING_CONTEXT_HINT_V1: 'suntrail_recording_context_hint_v1',
    PRO_CONTEXT_HINT_V1: 'suntrail_pro_context_hint_v1',

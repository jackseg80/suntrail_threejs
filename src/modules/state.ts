...
export const PRESETS: Record<Exclude<PresetType, 'custom'>, PerformanceSettings> = {
    ...
    balanced: {
        ...
        MAX_ALLOWED_ZOOM: 16, VEGETATION_DENSITY: 4000, BUILDING_LIMIT: 40, POI_ZOOM_THRESHOLD: 15, BUILDING_ZOOM_THRESHOLD: 16,
    ...
    performance: {
        ...
        MAX_ALLOWED_ZOOM: 18, VEGETATION_DENSITY: 10000, BUILDING_LIMIT: 80, POI_ZOOM_THRESHOLD: 14, BUILDING_ZOOM_THRESHOLD: 15,
    ...
    ultra: {
        ...
        SHOW_VEGETATION: true, SHOW_SIGNPOSTS: true, SHOW_BUILDINGS: true, SHOW_HYDROLOGY: true, BUILDINGS_SHADOWS: true,
        MAX_ALLOWED_ZOOM: 18, VEGETATION_DENSITY: 18000, BUILDING_LIMIT: 150, POI_ZOOM_THRESHOLD: 14, BUILDING_ZOOM_THRESHOLD: 15,
...
const CURRENT_SETTINGS_VERSION = '5.8.7';

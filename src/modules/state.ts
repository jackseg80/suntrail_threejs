...
export const PRESETS: Record<Exclude<PresetType, 'custom'>, PerformanceSettings> = {
    ...
    performance: {
        RESOLUTION: 192, RANGE: 4, SHADOWS: true, SHADOW_RES: 2048, PIXEL_RATIO_LIMIT: 1.5,
    ...
    ultra: {
        RESOLUTION: 256, RANGE: 6, SHADOWS: true, SHADOW_RES: 4096, PIXEL_RATIO_LIMIT: window.devicePixelRatio,
        SHOW_VEGETATION: true, SHOW_SIGNPOSTS: true, SHOW_BUILDINGS: true, BUILDINGS_SHADOWS: true,

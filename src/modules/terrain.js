...
// v2.0.0: originTile est TOUJOURS au Zoom 13
...
export async function updateVisibleTiles(camLat, camLon, camAltitude, worldX, worldZ) {
    ...
    // On utilise le zoom du slider pour les données, mais on place tout sur la grille Z13
...
async function loadSingleTile(tx, ty, zoom, key) {
    ...
    try {
        ...
        // v2.0.0 Relative Placement (Immuable)
        ...
        mesh.position.set(dx, 0, dz); // Placement v2.0.0

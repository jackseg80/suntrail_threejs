# SunTrail — Roadmap produit révisée (version source v5.91.0)

> Révision produit : 2026-09-16. La source `5.91.0` / Android `913` ajoute la refonte du profil de
> pente (bandes de couleur façon Openrunner, échelle unique montée/descente) et le cadrage caméra
> adapté aux dimensions du tracé au-dessus de `5.90.0` / `911` et du correctif local `5.90.1` /
> `912`. Aucun téléversement Play de 912 ou 913 n'est revendiqué ; le statut et le maximum de

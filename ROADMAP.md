# SunTrail — Roadmap produit révisée (version source v5.91.2)

> Révision produit : 2026-09-16. La source `5.91.2` / Android `915` rend la trace lisible sur toutes
> les cartes (couleur unique réglable + casing deux tons, coloration solaire optionnelle) et affine
> le profil et les réglages, au-dessus de `5.91.1` / `914`. Aucun téléversement Play de 913, 914 ou
> 915 n'est revendiqué ; le statut et le maximum de versionCode de la Play Console restent à vérifier
> séparément.

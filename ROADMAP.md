# SunTrail — Roadmap produit révisée (version source v5.91.4)

> Révision produit : 2026-09-17. La source `5.91.4` / Android `917` corrige le démarrage carte
> (lecture `CacheStorage` sortie du thread principal, repli local borné) et nettoie les réglages
> avancés, au-dessus de `5.91.3` / `916`. Aucun téléversement Play de 914 à 917 n'est revendiqué ; le
> statut et le maximum de versionCode de la Play Console restent à vérifier séparément.

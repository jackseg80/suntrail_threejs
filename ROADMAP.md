# SunTrail — Roadmap produit révisée (version source v5.91.3)

> Révision produit : 2026-09-16. La source `5.91.3` / Android `916` recolore la trace REC en vert
> fluo et réserve l'inclinomètre au mode 3D, au-dessus de `5.91.2` / `915`. Aucun téléversement Play
> de 914, 915 ou 916 n'est revendiqué ; le statut et le maximum de versionCode de la Play Console

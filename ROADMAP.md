# SunTrail — Roadmap produit révisée (version source v5.90.1)

> Révision produit : 2026-09-15. La source `5.90.1` / Android `912` ajoute le correctif de
> luminosité 3D en heure dorée au-dessus de `5.90.0` / `911`, qualifiée localement après validation
> A53/S23. Aucun téléversement Play de 911 ou 912 n'est revendiqué ; le statut et le maximum de

# SunTrail — Roadmap produit révisée (version source v5.91.1)

> Révision produit : 2026-09-16. La source `5.91.1` / Android `914` fiabilise l'analyse solaire du
> parcours (relief préchargé le long du tracé, ombres inconnues hachurées, raycast borné) et rend
> les informations du profil lisibles sur petit écran, au-dessus de `5.91.0` / `913`. Aucun
> téléversement Play de 912, 913 ou 914 n'est revendiqué ; le statut et le maximum de versionCode de
> la Play Console restent à vérifier séparément.

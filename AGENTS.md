...
- **Végétation Bio-Fidèle (v5.8.14)** : Sélection des essences d'arbres basée sur l'altitude réelle. Utilisation d'un **Dithered Scan** (échantillonnage aléatoire des pixels) pour éliminer le moiré et les bandes. Inclusion d'un **Filtre de Forêt Continue** capturant le fond clair et les symboles sombres de SwissTopo tout en excluant strictement les prairies lumineuses. Nouveauté (v5.8.14) : **Normalisation de Densité stricte** et jitter spatial accru pour une continuité parfaite entre les LOD.

...
- **Végétation Bio-Fidèle (v5.8.13)** : Sélection des essences d'arbres basée sur l'altitude réelle. Utilisation d'un **Adaptive Scan** (résolution 64). Inclusion d'un **Filtre Anti-Pelouse Avancé**. Nouveauté (v5.8.13) : **Continuité LOD** ; correction du quota d'arbres par tuile (normalisation par l'aire physique) pour éviter l'explosion de densité aux LOD 16, 17 et 18. Distribution homogène par placement probabiliste.

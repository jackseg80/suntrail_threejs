...
- **Authentification Google et achat invité Web** — Réactiver l'UI uniquement après avoir fiabilisé le retour OAuth mobile, la liaison de compte et la restauration des achats ; les parcours sont masqués en attendant.

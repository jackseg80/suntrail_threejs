# Prompt autonome — SunTrail v6.2.0 Compte optionnel & synchronisation

Travaille seulement après v6.0 et v6.1, et après une décision active confirmant que la continuité
PC–Android mérite ce coût produit. Réalise-la sans rendre le compte nécessaire et sans perdre
routes ni entitlements. N'expose aucun bouton Google avant validation E2E.
...
- App sans compte identique à la baseline v5.87.

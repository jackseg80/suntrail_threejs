...
> Révision du 2026-09-08. Utiliser le même worktree et respecter l'ordre.
...
| 8 | v5.89 | [Évaluation de l'architecture cartographique](../V5_89_MAP_ARCHITECTURE_EVALUATION.md) | Reproduction navigateur, presets, mémoire et décision bornée avant nouvelles fonctions |
...
3. v5.82 à v5.87 appartiennent à la baseline livrée. v5.88 stabilise cette baseline sur A53 avant
   ...
   Guidance ou Free/Pro. Le prochain jalon est v5.89 : évaluer l'architecture cartographique en
   conservant les contraintes des presets et de mémoire. Les noms de fichiers V6 sont conservés

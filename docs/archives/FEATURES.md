...
*   **Support Multi-Source Topo** : Basculement automatique entre **SwissTopo** (Suisse), **IGN** (France), **basemap.at** (Autriche), **BKG** (Allemagne), **IGN España**, **Kartverket** (Norvège) et **OpenTopoMap** (Monde) selon la position.

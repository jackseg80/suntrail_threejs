...
| Packs           | PMTiles via OPFS, droits RevenueCat vérifiés et archive locale invalidée proprement si illisible                                                                                                  | Suisse, Alpes françaises et Autriche dans le catalogue embarqué | `packCatalog.ts`, `packManager.ts`                      |

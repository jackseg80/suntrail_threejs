...
> Référence canonique de la source 5.91.4 avec correctifs non publiés, mise à jour le 2026-09-19.
...
| :-------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------- | :--------------------------------------------------------- |
| Carte           | Relief Three.js, bascule 2D/3D avec reconstruction sûre des tuiles, couleur 2D prioritaire et LOD 5 à 18                                                                                                                   | Free jusqu'à 14, Pro jusqu'à 18                                 | `scene.ts`, `terrain.ts`                                   |
...
| Solaire         | Données astronomiques en 2D/3D ; ombres, frise 24 h et exposition calculée sur l'altitude physique, avec relief manquant explicitement inconnu                                                                             | Jour courant Free, calendrier Pro                               | `sun.ts`, `solarRoute.ts`, `SolarProbeSheet.ts`            |
...
| Préparation     | Bandeau Suivre/Enregistrer/Points/Profil/Configuration, points `1…n`, réorganisation/suppression et réouverture pendant le guidage avec application des changements, activité, boucle, inversion et recalcul ORS puis OSRM | Free jusqu'à 25 km, Pro jusqu'à 500 km                          | `routeManager.ts`, `preparedRoutes/`                       |
...
| Traces          | Import GPX sérialisé et archive REC/import `StoredTrackV1` pleine fidélité ; REC actif vert et terminé bleu                                                                                                                | Toutes conservées localement                                    | `tracks/`, `TRACK_STORAGE.md`                              |
| Affichage       | Chevrons de direction sur toute trace ; double voie sur aller-retour ; une trace de Bibliothèque à la fois en Free et ajout multi-carte en Pro                                                                             | Maximum technique de 10 calques                                 | `gpxLayers.ts`, `TrackSheet.ts`                            |
...
| Packs           | PMTiles via OPFS, droits RevenueCat vérifiés, taille/structure/zooms contrôlés avant installation et archive invalide supprimée proprement                                                                                 | Suisse, Alpes françaises et Autriche dans le catalogue embarqué | `packCatalog.ts`, `packManager.ts`, `READINESS_OFFLINE.md` |
